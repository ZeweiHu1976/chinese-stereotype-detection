...
def train_model(train_data, model_path, batch_size, epoch, learning_rate, model_output_base_dir, dataset_name, seed):
    ...
    training_args = TrainingArguments(
        output_dir=model_output_dir, num_train_epochs=epoch, eval_strategy="epoch", learning_rate=learning_rate,
...
train_model(train_data_winoqueer_gpt_augmentation, model_path='albert/albert-base-v2', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_albertv2', dataset_name='winoqueer_gpt_augmentation_trained', seed=42)
...
train_model(train_data_seegull_gpt_augmentation, model_path='albert/albert-base-v2', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_albertv2', dataset_name='seegull_gpt_augmentation_trained', seed=42)
...
train_model(train_data_merged_winoqueer_seegull_gpt_augmentation, model_path='albert/albert-base-v2', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_albertv2', dataset_name='merged_winoqueer_seegull_gpt_augmentation_trained', seed=42)
...
train_model(train_data_mgsd, model_path='distilbert/distilbert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_distilbert', dataset_name='mgsd_trained', seed=42)
...
train_model(train_data_winoqueer_gpt_augmentation, model_path='distilbert/distilbert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_distilbert', dataset_name='winoqueer_gpt_augmentation_trained', seed=42)
...
train_model(train_data_seegull_gpt_augmentation, model_path='distilbert/distilbert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_distilbert', dataset_name='seegull_gpt_augmentation_trained', seed=42)
...
train_model(train_data_merged_winoqueer_seegull_gpt_augmentation, model_path='distilbert/distilbert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_distilbert', dataset_name='merged_winoqueer_seegull_gpt_augmentation_trained', seed=42)
...
train_model(train_data_mgsd, model_path='google-bert/bert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_bert', dataset_name='mgsd_trained', seed=42)
...
train_model(train_data_winoqueer_gpt_augmentation, model_path='google-bert/bert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_bert', dataset_name='winoqueer_gpt_augmentation_trained', seed=42)
...
train_model(train_data_seegull_gpt_augmentation, model_path='google-bert/bert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_bert', dataset_name='seegull_gpt_augmentation_trained', seed=42)
...
train_model(train_data_merged_winoqueer_seegull_gpt_augmentation, model_path='google-bert/bert-base-uncased', batch_size=128, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_bert', dataset_name='merged_winoqueer_seegull_gpt_augmentation_trained', seed=42)
